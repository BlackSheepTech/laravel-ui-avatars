...
class UiAvatarsService
{
    ...
    private function validateHexColor(string $color, string $parameter = 'color', bool $canBeRandom = false): void
    {
        $pattern = $canBeRandom ? '/^([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3}|random)$/i' : '/^([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/i';
